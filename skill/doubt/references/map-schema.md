  ...
  "sources": [
    {
      ...
      "verification": {
        ...
        "locatorStatus": "matched or not-machine-checked"
      }
    }
  ]
}
...
- `verification` is optional and must only be written by a successful explicit
  `doubt verify` run. It binds the receipt to the retrieved bytes and matched
